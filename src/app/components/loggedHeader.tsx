...
const LoggedHeader: React.FC = () => {
  return (
    <>        
      <div className="flex flex-wrap items-center bg-backgroundPurple p-4 md:p-4">
        {/* Logo */}
        ...
        <div className="flex items-center justify-end space-x-3 mt-4 md:mt-0">
          <h4 className="flex items-center justify-center bg-blue-400 h-8 p-3 mr-4 md:h-20 w-48 md:w-72 rounded-xl text-white text-lg md:text-2xl">Nome do Atleta</h4>
        </div>
      </div>
    </>
  );
